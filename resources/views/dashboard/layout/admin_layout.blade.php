...
<!DOCTYPE html>
<head>
<title>MylaStore | Trang admin</title>
...
<!--logo start-->
<div class="brand">
    <a href="{{ route('PageAdmin') }}" class="logo">
        Admin
    </a>
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username">{{ Session()->get('Login')->name }}</span>
                <b class="caret"></b>
            </a>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a class="active" href="{{ route('PageAdmin') }}">
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | By <i class="fa fa-heart" aria-hidden="true"></i>  <a href="https://www.facebook.com/diem.xuavanay.5" target="_blank">Nhật Trường Nguyễn</a>
			</div>
		  </div>
  <!-- / footer -->
</section>
