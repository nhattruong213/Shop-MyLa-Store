...
<head>
    ...
    <title>Thông báo đặt hàng | MylaStore</title>
</head>
                        ...
                        @if($order->payment_type == "pay_later")
                            <td class="pl-3" style=" padding-left:15px;">
                                <span class="d-inline"
                                      ...
                                      Bạn sẽ thanh toán khi nhận hàng. Chúng tôi vừa bàn giao đơn hàng của bạn cho một đơn vị vận chuyển. MyLaStore freeship cho đơn hàng từ 199k
                                </span>
                            </td>
                        @endif
                    ...
                    <div class="row pl-3 py-2" style="background-color: #fff; padding: 10px 20px 10px 20px;">
                        <table class="table table-sm table-hover"
                            ...
                            <tr>
                                ...
                                <th style="padding: 5px 20px 5px 0; text-align: right;">Tổng đơn</th>
                            </tr>
                            </thead>
                            <tbody>
            ...
            <div class="row mt-2 mb-4" style="margin-top: 15px; margin-bottom: 25px;">
                <div class="container-fluid">
                    ...
                    <div class="row pl-3 py-2" style="background-color: #fff; padding: 10px 20px;">
                        ...
                        <p>Nếu sản phẩm có dấu hiệu hư hỏng / vỡ hoặc không khớp với thông tin trên
